...
class downloader:
    ...
    priority = {'low': {'Kickassanimev2': 1, 'KickAssAnimeX': -2, 'Beta-Server': 1, 'BetaServer3': 2, 'mobile-v2': -1,
                        'a-kickassanime': -1, 'Theta-Original': -1, }}
    ...
    def make_downloads(self):
        ...
        for i in self.fetch_episodes:
            ...
            try:
                ...
                print(f'server/ quality not found, trying any available quality, with error {e}')
                print()
                var.quality = -1
                var.get_final_links(needed_server)
                continue
